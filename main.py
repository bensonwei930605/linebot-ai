...
def generate_three_strategies(text):
    ...
    if any(kw in text_lower for kw in ["小朋友", "小孩", "兒童", "幾歲"]):
        strategy_1 = "• 客戶想尋找適合兒童/小朋友騎乘的腳踏車，屬於家庭休閒或學步車需求。"
        strategy_2 = "• 市面常見熱門推薦：12-20吋童車（如 Giant 跨欄車系列、rmc 或 specialized 兒童成車），注重安全與輕量化。"
        strategy_3 = "• 建議直接回覆：「小朋友的車我們通常會看身高來挑尺寸（像是 20 吋或變速小車），店裡有好幾款安全又好騎的兒童車，可以帶小朋友來試乘看看！」"
    elif any(kw in text_lower for kw in ["10萬", "預算", "車款"]):
        strategy_1 = "• 客戶手握明確高預算，想找進階或高階成車。"
        strategy_2 = "• 市面熱門推薦：碳纖車架搭配 105 電變（如 TCR Advanced 系列）。"
        strategy_3 = "• 建議直接回覆：「10萬預算可以直接看碳纖車配電變的款式，性價比最好，這週末有空直接來店裡看實車！」"
